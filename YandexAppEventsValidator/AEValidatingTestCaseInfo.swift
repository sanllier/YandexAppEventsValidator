//
//  AEValidatingTestCaseInfo.swift
//  YandexMaps
//
...
public class AEValidatingTestCaseInfo: Equatable {
    ...
    public static func ==(lhs: AEValidatingTestCaseInfo, rhs: AEValidatingTestCaseInfo) -> Bool {
...
fileprivate extension AEValidatingTestCaseInfo {
