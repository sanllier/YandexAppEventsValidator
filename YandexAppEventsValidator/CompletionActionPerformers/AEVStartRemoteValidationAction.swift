//
//  AEVStartRemoteValidationAction.swift
//  YandexMaps
//
...
class AEVStartRemoteValidationAction: AEVAction {
    ...
    fileprivate func runValidation(for uuid: String, info: AEVTestCaseInfo, completion: @escaping Completion) {
