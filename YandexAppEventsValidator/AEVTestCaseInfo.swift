...
public class AEVTestCaseInfo: Equatable {
    ...
    public static func ==(lhs: AEVTestCaseInfo, rhs: AEVTestCaseInfo) -> Bool {
...
fileprivate extension AEVTestCaseInfo {
